    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to=courses.image_load.AvatarUpload._upload, verbose_name='Аватар')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='Электронная почта')),
                ('phone', models.CharField(max_length=20, verbose_name='Номер телефона')),
                ('role', models.CharField(choices=[('teacher', 'Teacher'), ('user', 'User')], default='user', max_length=30, verbose_name='Должность')),
